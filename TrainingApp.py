...
class MyProfile():
    def __init__(self, master):
        ...
        self.topFrameDochazka = Frame(frame3)
    ...
    def detail_window(self):
        x = messagebox.askquestion("", "Zobrazit detail docházky?")
        if(x == 'yes'):
...
class DetailWindow():
    def __init__(self, master, old_window, row):
        ...
        self.topFrameTOP = Frame(master, relief='raised', bd=2)
        self.topFrameTOP.pack(side="top",fill=X,pady=10)
        ...
        self.hrac_cislo = Label(self.topFrameTOP, font=('arial',10,'bold'), text='Číslo', padx=2, pady=2, width=15)
        self.hrac_cislo.grid(row=0, column=1, sticky=W)
        self.hrac_jmeno = Label(self.topFrameTOP, font=('arial',10,'bold'), text='Jméno', padx=2, pady=2, width=15)
        self.hrac_jmeno.grid(row=0, column=2, sticky=W)
        self.box = Label(self.topFrameTOP, font=('arial',10,'bold'), text='Přítomnost', padx=2, pady=2, width=15)
        self.box.grid(row=0, column=4)
        self.hrac_omluva = Label(self.topFrameTOP, font=('arial',10,'bold'), text='Omluveno', padx=2, pady=2, width=15)
        self.hrac_omluva.grid(row=0, column=6)
        self.hrac_notes = Label(self.topFrameTOP, font=('arial',10,'bold'), text='Poznámky', padx=2, pady=2, width=15)
        self.hrac_notes.grid(row=0, column=8)
        self.datum = Text(self.topFrameTOP, padx=2, pady=2, width=15, height=1)
        self.datum.grid(row=0, column=10)
        self.datum.insert('1.0',today)
        self.datum.config(state=DISABLED)

        self.hrac1_cislo = Label(self.topFrame, font=('arial',10,'bold'), text='1', padx=2, pady=2, bd=2, width=15)
        self.hrac1_cislo.grid(row=1, column=1, sticky=W)
        self.hrac1_jmeno = Label(self.topFrame, font=('arial',10,'bold'), text='Jakub Jancicka', padx=2, pady=2, bd=2, width=15)
        self.hrac1_jmeno.grid(row=1, column=2, sticky=W)
        self.box1 = ttk.Combobox(self.topFrame, state='readonly')
        self.box1['values'] = ('ANO', 'NE')
        self.box1.current(0)
        self.box1.grid(row=1, column=4)
        self.boxO1 = ttk.Combobox(self.topFrame, state='readonly')
        self.boxO1['values'] = (' ', 'OMLUVENO', 'NEOMLUVENO')
        self.boxO1.current(0)
        self.boxO1.grid(row=1, column=6)
        self.hrac1_notes= Text(self.topFrame, padx=2, pady=2, bd=2, width=15, height=1)
        self.hrac1_notes.grid(row=1, column=8)


        self.hrac2_cislo = Label(self.topFrame, font=('arial',10,'bold'), text='2', padx=2, pady=2, bd=2, width=15)
        self.hrac2_cislo.grid(row=2, column=1, sticky=W)
        self.hrac2_jmeno = Label(self.topFrame, font=('arial',10,'bold'), text='Jindřich Korbel', padx=2, pady=2, bd=2, width=15)
        self.hrac2_jmeno.grid(row=2, column=2, sticky=W)
        self.box2 = ttk.Combobox(self.topFrame, state='readonly')
        self.box2['values'] = ('ANO', 'NE')
        self.box2.current(0)
        self.box2.grid(row=2, column=4)
        self.boxO2 = ttk.Combobox(self.topFrame, state='readonly')
        self.boxO2['values'] = (' ', 'OMLUVENO', 'NEOMLUVENO')
        self.boxO2.current(0)
        self.boxO2.grid(row=2, column=6)
        self.hrac2_notes= Text(self.topFrame, padx=2, pady=2, bd=2, width=15, height=1)
        self.hrac2_notes.grid(row=2, column=8)


        self.hrac3_cislo = Label(self.topFrame, font=('arial',10,'bold'), text='3', padx=2, pady=2, bd=2, width=15)
        self.hrac3_cislo.grid(row=3, column=1, sticky=W)
        self.hrac3_jmeno = Label(self.topFrame, font=('arial',10,'bold'), text='Vladislav Skala', padx=2, pady=2, bd=2, width=15)
        self.hrac3_jmeno.grid(row=3, column=2, sticky=W)
        self.box3 = ttk.Combobox(self.topFrame, state='readonly')
        self.box3['values'] = ('ANO', 'NE')
        self.box3.current(0)
        self.box3.grid(row=3, column=4)
        self.boxO3 = ttk.Combobox(self.topFrame, state='readonly')
        self.boxO3['values'] = (' ', 'OMLUVENO', 'NEOMLUVENO')
        self.boxO3.current(0)
        self.boxO3.grid(row=3, column=6)
        self.hrac3_notes= Text(self.topFrame, padx=2, pady=2, bd=2, width=15, height=1)
        self.hrac3_notes.grid(row=3, column=8)


        self.hrac4_cislo = Label(self.topFrame, font=('arial',10,'bold'), text='4', padx=2, pady=2, bd=2, width=15)
        self.hrac4_cislo.grid(row=4, column=1, sticky=W)
        self.hrac4_jmeno = Label(self.topFrame, font=('arial',10,'bold'), text='Ludvík Varmuža', padx=2, pady=2, bd=2, width=15)
        self.hrac4_jmeno.grid(row=4, column=2, sticky=W)
        self.box4 = ttk.Combobox(self.topFrame, state='readonly')
        self.box4['values'] = ('ANO', 'NE')
        self.box4.current(0)
        self.box4.grid(row=4, column=4)
        self.boxO4 = ttk.Combobox(self.topFrame, state='readonly')
        self.boxO4['values'] = (' ', 'OMLUVENO', 'NEOMLUVENO')
        self.boxO4.current(0)
        self.boxO4.grid(row=4, column=6)
        self.hrac4_notes= Text(self.topFrame, padx=2, pady=2, bd=2, width=15, height=1)
        self.hrac4_notes.grid(row=4, column=8)

        self.hrac5_cislo = Label(self.topFrame, font=('arial',10,'bold'), text='5', padx=2, pady=2, bd=2, width=15)
        self.hrac5_cislo.grid(row=5, column=1, sticky=W)
        self.hrac5_jmeno = Label(self.topFrame, font=('arial',10,'bold'), text='Zikmund Matula', padx=2, pady=2, bd=2, width=15)
        self.hrac5_jmeno.grid(row=5, column=2, sticky=W)
        self.box5 = ttk.Combobox(self.topFrame, state='readonly')
        self.box5['values'] = ('NE')
        self.box5.current(0)
        self.box5.grid(row=5, column=4)
        self.boxO5 = ttk.Combobox(self.topFrame, state='readonly')
        self.boxO5['values'] = ('OMLUVENO', 'NEOMLUVENO')
        self.boxO5.current(0)
        self.boxO5.grid(row=5, column=6)
        self.hrac5_notes= Text(self.topFrame, padx=2, pady=2, bd=2, width=15, height=1)
        self.hrac5_notes.grid(row=5, column=8)
        self.hrac5_notes.insert(END, "Doktor")

        self.hrac6_cislo = Label(self.topFrame, font=('arial',10,'bold'), text='6', padx=2, pady=2, bd=2, width=15)
        self.hrac6_cislo.grid(row=6, column=1, sticky=W)
        self.hrac6_jmeno = Label(self.topFrame, font=('arial',10,'bold'), text='Otakar Vytlačil', padx=2, pady=2, bd=2, width=15)
        self.hrac6_jmeno.grid(row=6, column=2, sticky=W)
        self.box6 = ttk.Combobox(self.topFrame, state='readonly')
        self.box6['values'] = ('ANO', 'NE')
        self.box6.current(0)
        self.box6.grid(row=6, column=4)
        self.boxO6 = ttk.Combobox(self.topFrame, state='readonly')
        self.boxO6['values'] = (' ', 'OMLUVENO', 'NEOMLUVENO')
        self.boxO6.current(0)
        self.boxO6.grid(row=6, column=6)
        self.hrac6_notes= Text(self.topFrame, padx=2, pady=2, bd=2, width=15, height=1)
        self.hrac6_notes.grid(row=6, column=8)

        self.hrac7_cislo = Label(self.topFrame, font=('arial',10,'bold'), text='7', padx=2, pady=2, bd=2, width=15)
        self.hrac7_cislo.grid(row=7, column=1, sticky=W)
        self.hrac7_jmeno = Label(self.topFrame, font=('arial',10,'bold'), text='Řehoř Studnička', padx=2, pady=2, bd=2, width=15)
        self.hrac7_jmeno.grid(row=7, column=2, sticky=W)
        self.box7 = ttk.Combobox(self.topFrame, state='readonly')
        self.box7['values'] = ('ANO', 'NE')
        self.box7.current(0)
        self.box7.grid(row=7, column=4)
        self.boxO7 = ttk.Combobox(self.topFrame, state='readonly')
        self.boxO7['values'] = (' ', 'OMLUVENO', 'NEOMLUVENO')
        self.boxO7.current(0)
        self.boxO7.grid(row=7, column=6)
        self.hrac7_notes= Text(self.topFrame, padx=2, pady=2, bd=2, width=15, height=1)
        self.hrac7_notes.grid(row=7, column=8)

        self.hrac8_cislo = Label(self.topFrame, font=('arial',10,'bold'), text='8', padx=2, pady=2, bd=2, width=15)
        self.hrac8_cislo.grid(row=8, column=1, sticky=W)
        self.hrac8_jmeno = Label(self.topFrame, font=('arial',10,'bold'), text='David Hák', padx=2, pady=2, bd=2, width=15)
        self.hrac8_jmeno.grid(row=8, column=2, sticky=W)
        self.box8 = ttk.Combobox(self.topFrame, state='readonly')
        self.box8['values'] = ('ANO', 'NE')
        self.box8.current(0)
        self.box8.grid(row=8, column=4)
        self.boxO8 = ttk.Combobox(self.topFrame, state='readonly')
        self.boxO8['values'] = (' ', 'OMLUVENO', 'NEOMLUVENO')
        self.boxO8.current(0)
        self.boxO8.grid(row=8, column=6)
        self.hrac8_notes= Text(self.topFrame, padx=2, pady=2, bd=2, width=15, height=1)
        self.hrac8_notes.grid(row=8, column=8)
        
        self.hrac9_cislo = Label(self.topFrame, font=('arial',10,'bold'), text='9', padx=2, pady=2, bd=2, width=15)
        self.hrac9_cislo.grid(row=9, column=1, sticky=W)
        self.hrac9_jmeno = Label(self.topFrame, font=('arial',10,'bold'), text='Tibor Kulík', padx=2, pady=2, bd=2, width=15)
        self.hrac9_jmeno.grid(row=9, column=2, sticky=W)
        self.box9 = ttk.Combobox(self.topFrame, state='readonly')
        self.box9['values'] = ('NE')
        self.box9.current(0)
        self.box9.grid(row=9, column=4)
        self.boxO9 = ttk.Combobox(self.topFrame, state='readonly')
        self.boxO9['values'] = ('OMLUVENO', 'NEOMLUVENO')
        self.boxO9.current(0)
        self.boxO9.grid(row=9, column=6)
        self.hrac9_notes= Text(self.topFrame, padx=2, pady=2, bd=2, width=15, height=1)
        self.hrac9_notes.grid(row=9, column=8)
        self.hrac9_notes.insert(END, "Zubař")

        self.hrac10_cislo = Label(self.topFrame, font=('arial',10,'bold'), text='10', padx=2, pady=2, bd=2, width=15)
        self.hrac10_cislo.grid(row=10, column=1, sticky=W)
        self.hrac10_jmeno = Label(self.topFrame, font=('arial',10,'bold'), text='Vlastislav Pop', padx=2, pady=2, bd=2, width=15)
        self.hrac10_jmeno.grid(row=10, column=2, sticky=W)
        self.box10 = ttk.Combobox(self.topFrame, state='readonly')
        self.box10['values'] = ('ANO', 'NE')
        self.box10.current(0)
        self.box10.grid(row=10, column=4)
        self.boxO10 = ttk.Combobox(self.topFrame, state='readonly')
        self.boxO10['values'] = (' ', 'OMLUVENO', 'NEOMLUVENO')
        self.boxO10.current(0)
        self.boxO10.grid(row=10, column=6)
        self.hrac10_notes= Text(self.topFrame, padx=2, pady=2, bd=2, width=15, height=1)
        self.hrac10_notes.grid(row=10, column=8)

        self.hrac11_cislo = Label(self.topFrame, font=('arial',10,'bold'), text='11', padx=2, pady=2, bd=2, width=15)
        self.hrac11_cislo.grid(row=11, column=1, sticky=W)
        self.hrac11_jmeno = Label(self.topFrame, font=('arial',10,'bold'), text='Svatoslav Med', padx=2, pady=2, bd=2, width=15)
        self.hrac11_jmeno.grid(row=11, column=2, sticky=W)
        self.box11 = ttk.Combobox(self.topFrame, state='readonly')
        self.box11['values'] = ('ANO', 'NE')
        self.box11.current(0)
        self.box11.grid(row=11, column=4)
        self.boxO11 = ttk.Combobox(self.topFrame, state='readonly')
        self.boxO11['values'] = (' ', 'OMLUVENO', 'NEOMLUVENO')
        self.boxO11.current(0)
        self.boxO11.grid(row=11, column=6)
        self.hrac11_notes= Text(self.topFrame, padx=2, pady=2, bd=2, width=15, height=1)
        self.hrac11_notes.grid(row=11, column=8)

        self.hrac12_cislo = Label(self.topFrame, font=('arial',10,'bold'), text='12', padx=2, pady=2, bd=2, width=15)
        self.hrac12_cislo.grid(row=12, column=1, sticky=W)
        self.hrac12_jmeno = Label(self.topFrame, font=('arial',10,'bold'), text='Mojmír Vaníček', padx=2, pady=2, bd=2, width=15)
        self.hrac12_jmeno.grid(row=12, column=2, sticky=W)
        self.box12 = ttk.Combobox(self.topFrame, state='readonly')
        self.box12['values'] = ('ANO', 'NE')
        self.box12.current(0)
        self.box12.grid(row=12, column=4)
        self.boxO12 = ttk.Combobox(self.topFrame, state='readonly')
        self.boxO12['values'] = (' ', 'OMLUVENO', 'NEOMLUVENO')
        self.boxO12.current(0)
        self.boxO12.grid(row=12, column=6)
        self.hrac12_notes= Text(self.topFrame, padx=2, pady=2, bd=2, width=15, height=1)
        self.hrac12_notes.grid(row=12, column=8)

        self.hrac13_cislo = Label(self.topFrame, font=('arial',10,'bold'), text='13', padx=2, pady=2, bd=2, width=15)
        self.hrac13_cislo.grid(row=13, column=1, sticky=W)
        self.hrac13_jmeno = Label(self.topFrame, font=('arial',10,'bold'), text='Vladan Reich', padx=2, pady=2, bd=2, width=15)
        self.hrac13_jmeno.grid(row=13, column=2, sticky=W)
        self.box13 = ttk.Combobox(self.topFrame, state='readonly')
        self.box13['values'] = ('ANO', 'NE')
        self.box13.current(0)
        self.box13.grid(row=13, column=4)
        self.boxO13 = ttk.Combobox(self.topFrame, state='readonly')
        self.boxO13['values'] = ('OMLUVENO', 'NEOMLUVENO')
        self.boxO13.current(0)
        self.boxO13.grid(row=13, column=6)
        self.hrac13_notes= Text(self.topFrame, padx=2, pady=2, bd=2, width=15, height=1)
        self.hrac13_notes.grid(row=13, column=8)
        self.hrac13_notes.insert(END, "Pozdní příchod")

        self.hrac14_cislo = Label(self.topFrame, font=('arial',10,'bold'), text='14', padx=2, pady=2, bd=2, width=15)
        self.hrac14_cislo.grid(row=14, column=1, sticky=W)
        self.hrac14_jmeno = Label(self.topFrame, font=('arial',10,'bold'), text='Luboš Špičák', padx=2, pady=2, bd=2, width=15)
        self.hrac14_jmeno.grid(row=14, column=2, sticky=W)
        self.box14 = ttk.Combobox(self.topFrame, state='readonly')
        self.box14['values'] = ('ANO', 'NE')
        self.box14.current(0)
        self.box14.grid(row=14, column=4)
        self.boxO14 = ttk.Combobox(self.topFrame, state='readonly')
        self.boxO14['values'] = (' ', 'OMLUVENO', 'NEOMLUVENO')
        self.boxO14.current(0)
        self.boxO14.grid(row=14, column=6)
        self.hrac14_notes= Text(self.topFrame, padx=2, pady=2, bd=2, width=15, height=1)
        self.hrac14_notes.grid(row=14, column=8)

        self.hrac15_cislo = Label(self.topFrame, font=('arial',10,'bold'), text='15', padx=2, pady=2, bd=2, width=15)
        self.hrac15_cislo.grid(row=15, column=1, sticky=W)
        self.hrac15_jmeno = Label(self.topFrame, font=('arial',10,'bold'), text='Vilém Pompa', padx=2, pady=2, bd=2, width=15)
        self.hrac15_jmeno.grid(row=15, column=2, sticky=W)
        self.box15 = ttk.Combobox(self.topFrame, state='readonly')
        self.box15['values'] = ('ANO', 'NE')
        self.box15.current(0)
        self.box15.grid(row=15, column=4)
        self.boxO15 = ttk.Combobox(self.topFrame, state='readonly')
        self.boxO15['values'] = (' ', 'OMLUVENO', 'NEOMLUVENO')
        self.boxO15.current(0)
        self.boxO15.grid(row=15, column=6)
        self.hrac15_notes= Text(self.topFrame, padx=2, pady=2, bd=2, width=15, height=1)
        self.hrac15_notes.grid(row=15, column=8)

        self.hrac16_cislo = Label(self.topFrame, font=('arial',10,'bold'), text='16', padx=2, pady=2, bd=2, width=15)
        self.hrac16_cislo.grid(row=16, column=1, sticky=W)
        self.hrac16_jmeno = Label(self.topFrame, font=('arial',10,'bold'), text='Felix Hrabec', padx=2, pady=2, bd=2, width=15)
        self.hrac16_jmeno.grid(row=16, column=2, sticky=W)
        self.box16 = ttk.Combobox(self.topFrame, state='readonly')
        self.box16['values'] = ('ANO', 'NE')
        self.box16.current(0)
        self.box16.grid(row=16, column=4)
        self.boxO16 = ttk.Combobox(self.topFrame, state='readonly')
        self.boxO16['values'] = (' ', 'OMLUVENO', 'NEOMLUVENO')
        self.boxO16.current(0)
        self.boxO16.grid(row=16, column=6)
        self.hrac16_notes= Text(self.topFrame, padx=2, pady=2, bd=2, width=15, height=1)
        self.hrac16_notes.grid(row=16, column=8)


        self.topFrame.grid_columnconfigure(3, minsize=60)
        self.topFrame.grid_columnconfigure(5, minsize=85)
        self.topFrame.grid_columnconfigure(7, minsize=85)

        self.topFrameTOP.grid_columnconfigure(3, minsize=60)
        self.topFrameTOP.grid_columnconfigure(5, minsize=100)
        self.topFrameTOP.grid_columnconfigure(7, minsize=100)
        self.topFrameTOP.grid_columnconfigure(9, minsize=60)

        self.confirm_button = Button(self.bottom, text='Zavřít', bg='green',command = self.confirm_user,width=12,height=3)
